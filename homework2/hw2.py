...
# Relative path might take you through other directories while absolute path will not
...
# It removes entries for specificed files within a directory
# 6) In your current working directory, what does calling "git add" do? What about "git commit"? What about "git push"? 
# "git add" adds a change in the working directory to the staging area; "git commit" svaes the staged changes; "git push" uploads the local repository to a remote one
...
# it tells you what's in the staging area and what you're about to push
...
# I haven't really encoundered anything severe so far, but there's a lot to remember and I've struggled with that a bit - I feel like I have to look at my notes all the time and I don't retain anything I read anyway.
# 9) How does cloning a repository differ from pulling from a repository? 
# It'll make a copy in a different repository and pulling will move it 
